...
<html class="no-js"  lang="en">
	...
	<head>
		...
		<!-- TITLE OF SITE -->
		<title>Videography In Vadodara</title>
...
<div class="header">
     <div class="container">
         <div class="logo">
             <a href="index.php"><h1>Videography</h1></a>
         </div>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="services/assets/images/videog/visu.jpg" alt="package-place">
								<div class="single-package-item-txt">
									<h3>Visual Stories  <span class="pull-right">  ₹ 2500/hr </span></h3>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="services/assets/images/videog/avsar.jpg" alt="package-place">
								<div class="single-package-item-txt">
									<h3> Avsar Photography Studio<span class="pull-right"> ₹ 2500/hr </span></h3>
									<div class="packages-para">
										<p>
											 Address: 8 Annapurna Complex, Beside Angan Tower, makarpura, main road, Manjalpur, Vadodara, Gujarat 390011
										 </p>
									</div><!--/.packages-para-->
																		<div class="about-btn">
										<button  class="about-view packages-btn">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="services/assets/images/videog/memo.png" alt="package-place">
								<div class="single-package-item-txt">
									<h3>Memories Photography Studio<span class="pull-right"> ₹ 2000/hr </span></h3>
									<div class="packages-para">
										<p>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="services/assets/images/videog/maa.jpg" alt="package-place">
								<div class="single-package-item-txt">
									<h3>Maa Digital Studio<span class="pull-right"> ₹ 2200/hr </span></h3>
									<div class="packages-para">
										<p>
											Address: Suryadeep Apartment, 14, Harni Rd, Near Rupam Cinema, Vadodara, Gujarat 390006
										 </p>
									</div><!--/.packages-para-->
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="services/assets/images/videog/bucket.png" alt="package-place">
								<div class="single-package-item-txt">
									<h3>Memory Bucket <span class="pull-right"> ₹ 1500/hr </span></h3>
									<div class="packages-para">
										<p>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="services/assets/images/videog/freezing.jpg" alt="package-place">
								<div class="single-package-item-txt">
									<h3>Freezing Moments<span class="pull-right"> ₹ 2000/hr </span></h3>
									<div class="packages-para">
										<p>
											Address: 36 Ayodhyapuri society, behind Nisarg apartments, Old Padra Rd, Diwalipura, Vadodara, Gujarat 390007
										 </p>
									</div><!--/.packages-para-->
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="services/assets/images/videog/shivam.jpg" alt="package-place">
								<div class="single-package-item-txt">
									<h3>SHIVAM JOSHI PHOTOGRAPHY<span class="pull-right"> ₹ 2500/hr </span></h3>
									<div class="packages-para">
										<p>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="services/assets/images/videog/spect.png" alt="package-place">
								<div class="single-package-item-txt">
									<h3>Photospectrum<span class="pull-right"> ₹ 2200/hr </span></h3>
									<div class="packages-para">
										<p>
											AddressG 15 Landmark Complex, , Race Course Circle, Race Course Road, Vadodara - 390007
										 </p>
									</div><!--/.packages-para-->
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="services/assets/images/videog/happy.png" alt="package-place">
								<div class="single-package-item-txt">
									<h3>Happy Studio<span class="pull-right"> ₹ 1800/hr </span></h3>
									<div class="packages-para">
										<p>
